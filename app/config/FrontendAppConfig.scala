...
class FrontendAppConfig @Inject() (configuration: Configuration) {
  ...
  private val contactFormServiceIdentifier = "low-earners-anomaly-frontend"
  ...
  val exitSurveyUrl: String             = s"$exitSurveyBaseUrl/feedback/low-earners-anomaly-frontend"
